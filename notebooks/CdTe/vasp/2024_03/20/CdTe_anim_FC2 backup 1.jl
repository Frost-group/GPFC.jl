...
# ╔═╡ 582a41f0-e831-11ee-34d0-f94ad3fce1d1
begin
...
# ╔═╡ 2c3260b5-6409-47f4-bd4b-f6fd5c6d5ec0
begin
...
# ╔═╡ a9dc0fe6-a3af-433c-acb2-301e0f35f963
...
# ╔═╡ 605b087a-82f6-4368-9d16-a8f767067cb5
...
# ╔═╡ 47ea3f0b-ea01-4611-8f37-cead6afbb53e
...
# ╔═╡ a168bd32-0b1d-45f3-b408-15ced80f3b8f
begin
...
# ╔═╡ a7ab8b4d-0ae2-4a17-a036-7796a3fc9542
...
# ╔═╡ ba3cbd24-8318-4b8c-9695-593cfb2dbcc0
animCar = @animate for i in 1:size(nd,1)
	heatmap(1:size(P2[:,:,i],1),
		    ...
		    title="CdTe_FC2 (Traning Data = " *string(nd[i]) *")")
end

# ╔═╡ 1a79650c-d77e-4a5e-b475-255d6ca6236d
gif(animCar, "CdTe_FC2.gif", fps=2)

# ╔═╡ 97890807-53c4-43cb-b4b2-4dde1ec8de23
...
# ╔═╡ aff90b98-6f8f-4bf0-be4f-5c97b12755d5
gif(anim5, "CdTe_sum.gif", fps=2)

# ╔═╡ a5c6e9db-f21e-4f89-8253-c7b64a99af35
SumRule2
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "8ca51c9e33153e0ec88fbd7c53b62ee1ac474016"
