...
# ╔═╡ 3bc5a670-e80a-11ee-24c3-5b5169dff56b
begin
...
# ╔═╡ 9d3140f6-5d45-4b91-b7f2-5d176b0f6c67
begin
	σₒ = 0.4                  # Kernel Scale
	l = 0.4		    
...
# ╔═╡ 03628787-ff6c-4ad8-b209-8b29b5320b12
...
# ╔═╡ cf686861-5982-4373-abe4-2511abdc9e66
...
# ╔═╡ 0ed30921-3943-4964-ba45-fd3fe73fbc56
...
# ╔═╡ 806c15b1-fb58-473e-86d7-a6d5dbd2f521
...
# ╔═╡ ec685f28-7c4e-4529-96e3-8a456f256f66
@time Kₘₘ = Marginal(kernel, feature, σₑ, σₙ);

# ╔═╡ 204ad3fd-f13e-436a-a8b9-c20ada4c4e24
@time K₂ₙₘ = Coveriance_fc2(kernel, feature, equi);

# ╔═╡ bf6c31fd-d048-4d0e-8ccd-91bdfc2e3664
@time FC2 = PosteriorFC2(Kₘₘ, K₂ₙₘ, Target);

# ╔═╡ 33f751ce-033d-4e68-bc9d-dfdcc65f1f1f
...
# ╔═╡ a7b92c22-482e-48d3-a3c2-1b60d199adc5
FC2_re = recon_FC2(FC2);

# ╔═╡ d41a97e3-7ed0-4f9f-ba30-61ef53c3592c
begin
	a1 = mean(
...
# ╔═╡ 0517cd7d-0d93-468f-b5e7-fd4c818d70b9
begin
	a2 = mean(
	...
	h2 = mean(
			[FC2_re[:,:,2,11][1,1] FC2_re[:,:,2,11][2,2] FC2_re[:,:,2,11][3,3]]	
		)
	
	i2 = mean(
			[FC2_re[:,:,2,11][1,2] FC2_re[:,:,2,11][1,3] FC2_re[:,:,2,11][2,3]
			FC2_re[:,:,2,11][2,1] FC2_re[:,:,2,11][3,1] FC2_re[:,:,2,11][3,2]]	
		)
end

# ╔═╡ 070dbc40-e4c3-4ec6-a9d2-206488e27d32
FC2_re[:,:,2,:]

# ╔═╡ 4bc70983-8db1-45d5-b30c-79921670b994
Predict = [a1, b1, c1, d1, e1, f1, g1 ,h1, i1, a2, b2, c2, d2, e2, f2, g2 ,h2, i2]

# ╔═╡ 43e2e6bc-3db3-4731-bbd7-8bc2356946bd
f2

# ╔═╡ 6eee77c2-77f9-4d82-96db-a1b7fe87de0c
...
# ╔═╡ 21caad90-e4cd-4cc7-b419-4c3f0533c5d9
rmsd(Phon, Predict; normalize=false)

# ╔═╡ 9054c392-b4c2-4c55-ab83-542ca5d3c8ef
rmsd(Phon, Predict; normalize=false)
...
manifest_format = "2.0"
project_hash = "248244d9282da44ded3e201f1271b1fbdf839ab2"
...
git-tree-sha1 = "83806b5196e1e9827db0429a7579824c8b0e03ce"
