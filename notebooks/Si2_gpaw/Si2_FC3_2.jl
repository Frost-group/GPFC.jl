...
# ╔═╡ b92e5348-da16-11ee-220f-73ce8d056dba
begin
...
# ╔═╡ c7f3ebb9-ee7a-46fb-ac28-3af48b6fc10f
begin
	σₒ = 1.                  # Kernel Scale
	l = 0.4		    
...
# ╔═╡ 9913cfd4-a72a-4356-99ac-37525148972d
...
# ╔═╡ 8d334b35-4119-40e3-992b-2fdc3b329a65
...
# ╔═╡ eaec9a59-ba1b-458d-a16f-d78840296d25
...
# ╔═╡ 7f49c5a8-5ea1-4b6a-be5b-af29fa7528e8
@time Kₘₘ = Marginal(kernel, feature, σₑ, σₙ);

# ╔═╡ 6fd00a26-0330-4132-98d7-8ae0a6c56de3
@time K₃ₙₘ = Coveriance_fc3(kernel, feature, equi);

# ╔═╡ 3c692fc4-689b-4467-b731-a552633a0887
@time FC3 = PosteriorFC3(Kₘₘ, K₃ₙₘ, Target);

# ╔═╡ 61865edc-15d0-4c18-9067-5b3247aadf1c
...
# ╔═╡ 818a50b8-becd-4752-8902-f05d864d81f6
FC3_re = recon_FC3(FC3);

# ╔═╡ cc008ac2-1ec1-4d15-9dee-03671debd82f
FC3_re

# ╔═╡ 0265c34f-dd62-4f9f-b69c-d370570ed869
equi
