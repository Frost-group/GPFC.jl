...
disp = equi[1:3]-equi[4:6]

# ╔═╡ 7eb7819b-204a-45f9-84d3-f5ac0d4f494f
Supar = hcat(equi[7:9]-equi[1:3], equi[13:15]-equi[1:3], equi[25:27]-equi[1:3])
...
begin
	D 	  = 3   # dimension
    sgnum = 227 # space group number (≤2 in 1D, ≤17 in 2D, ≤230 in 3D)
...
begin
	W, w = (@SMatrix [0 0 1; 1 0 0; 0 1 0]), (@SVector [0, 0, 0])
	op = SymOperation(W, w)
end
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "11f108ea9e8be2e08d07ece3e50032a31313b617"
...
[[deps.Crystalline]]
deps = ["Bravais", "Combinatorics", "DelimitedFiles", "DocStringExtensions", "Graphs", "JLD2", "LayeredLayouts", "LinearAlgebra", "Meshing", "PrettyTables", "Reexport", "Requires", "SparseArrays", "StaticArrays", "Statistics"]
git-tree-sha1 = "27f7393d8516c8a038c83f884932c2b1a2fa2064"
