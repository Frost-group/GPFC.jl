...
# ╔═╡ a67e8d86-7024-416a-b985-fa527c1d37ed
energy

# ╔═╡ 1365ac5a-4887-403b-b7c1-4c4a4aa79ebf
energy[101]

# ╔═╡ fb3cb454-9fc2-4c3e-b3f8-ca8bfef109ad
energy[1] = -sqrt((-60.30348766)^2/(-60.29658902)^2 * (energy[3])^2)

# ╔═╡ ef3542a4-9bb4-45c5-a466-56b1eb8c99ed
Target[1] = energy[1]

# ╔═╡ 160fe31e-89ba-474c-9599-baecf1d3f46d
energy[2] = -sqrt((-60.29682672)^2/(-60.29658902)^2 * (energy[3])^2)

# ╔═╡ b7d5e9d6-a6bf-4396-9ee1-a36e00ca0ebe
Target[2] = energy[2]

# ╔═╡ eef4683f-dff7-46bc-9cdd-488937416091
energy[51] = -sqrt((-60.29826772)^2/(-60.29658902)^2 * (energy[3])^2)

# ╔═╡ 82a61fba-f34a-42e4-9b77-a3d8953dfb75
Target[51] = energy[51]

# ╔═╡ 9d82ba55-61a2-494e-9c39-493958619f5c
energy[101] = -sqrt((-60.29599837)^2/(-60.29658902)^2 * (energy[3])^2)

# ╔═╡ ec1cf95a-4723-4268-b64d-2fa8c1f0b5f4
Target[101] = energy[101]

# ╔═╡ b84fba7f-1e94-40e3-8071-f23001f705e5
energy[151] = -sqrt((-60.29968575)^2/(-60.29658902)^2 * (energy[3])^2)

# ╔═╡ e1c8aff8-39e8-4171-bb88-479bd6a4f9d7
Target[151] = energy[151]
