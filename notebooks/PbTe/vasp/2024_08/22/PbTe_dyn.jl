...
# ╔═╡ 97808bd8-647e-11ef-2806-99953b517a29
begin
...
# ╔═╡ 486263d8-b9b1-480d-a48a-7a9f9f5d4b2c
begin
...
# ╔═╡ 018bd084-1d19-4e4a-b8b8-0af07ac2d0f3
...
# ╔═╡ c914562b-6eb0-4d7d-b03d-cfae0cdd7f9c
...
# ╔═╡ 6eff8088-4017-4841-8180-70b163901cce
...
# ╔═╡ 13b2538f-1cc0-4a6a-b085-de3b1f888c72
...
# ╔═╡ 8e65b44f-3a9e-4708-885b-517058cf5238
...
# ╔═╡ db810d47-e8b3-4287-8e6c-568c2ddd4535
begin
...
# ╔═╡ a1cb3040-a81a-4a9a-b6f9-519ef755fa5c
...
# ╔═╡ 8803822f-a428-40e1-9ead-454580ea28ae
FC2ph

# ╔═╡ 9bcef1c2-71ee-42f3-8fae-b23dbcf1bc06
begin
	Pb = 1/sqrt(207.2)
	Te = 1/sqrt(127.6)
	begin
...
# ╔═╡ bc0efb8d-1489-4132-b976-0af8b76c6e2d
begin
	FC2ph_norm = zeros((6,6,size(nd,1)))
	Eph_Norm = zeros(size(nd,1))
	for i in 1:size(nd,1)
		FC2ph_norm[:,:,i] = invMass'*FC2ph[:,:,i]*invMass
		Eph_Norm[i] = sum(FC2ph_norm[:,:,i])
	end
end;

# ╔═╡ ead6f354-bd21-4c9d-8a25-438f930e56e7
function get_element(FC)
	Dyn1 = FC[1:3,1:3] 
	Dyn2 = (FC[1:3,4:6] + FC[4:6,1:3])/2
	Dyn3 = FC[4:6,4:6]
	A = mean([Dyn1[1,1], Dyn1[2,2], Dyn1[3,3]])
	B = mean([Dyn2[1,1], Dyn2[2,2], Dyn2[3,3]])
	C = mean([Dyn3[1,1], Dyn3[2,2], Dyn3[3,3]])
	return A, B, C
end

# ╔═╡ f6b3f2f8-89a0-4d2b-8787-a2764b464fb0
  Phonopy = [2.55292148e-03 -2.0039578e-03 1.5730327e-03]

# ╔═╡ d96fce19-4c51-4588-8719-39dc32ba3277
get_element(FC2ph_norm[:,:,16])

# ╔═╡ 90d39876-b5aa-4033-96e8-61e8e440d456
function RMSE(FC_set, Phonopy)
	...
	for iii in 1:size(FC_set,3)
		Dyna = FC_set[:,:,iii]
		A, B, C = get_element(Dyna)
		gpfc = [A, B, C] - [0.00066, -0.00066, 0.00066]
...
# ╔═╡ 6f1a9d9c-ec79-48ca-835c-70d5b2a08ac4
 RMSE(FC2ph_norm, Phonopy)
...
manifest_format = "2.0"
project_hash = "8d3d555a1d0a7d01f20185b37d4b6cb7ccdc9ba8"
