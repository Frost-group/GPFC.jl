...
begin
	...
	TOTEN = energy[1,:] #ion-electron free energy
...
# ╔═╡ a7e2e555-a7d7-460b-aa1d-90a783eef1c1
read(file)
...
begin
	#atomicnumber_ions = zeros(Int,length(type_ions)) # Vector, corresponds to type_ions
...
manifest_format = "2.0"
project_hash = "89ec392cb97bbd45e70c59d3889bdbe86fa51a22"
...
git-tree-sha1 = "c0945c98d53f6201b307e0fc78c6d1ca0302a9a4"
