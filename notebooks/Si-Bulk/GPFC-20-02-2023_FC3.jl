...
# ╔═╡ 6619217c-b110-11ed-1435-d560b04dea61
begin
...
# ╔═╡ eea6ec21-fe58-422d-b8a2-5e0fd22f3dc1
...
# ╔═╡ 71972b8f-491f-463a-b255-047830d517bc
...
# ╔═╡ b3cb495d-49da-43b4-af65-6d0a3fc81146
...
# ╔═╡ 3d488ef6-adce-4caa-9de3-f47c013f5508
...
# ╔═╡ 14ed70e1-ce84-4b35-9044-9125ebbc0733
...
# ╔═╡ e7a256e2-217b-4ec5-9eba-cc9a144a716c
begin
	#σₒ = 0.1
	#l = 0.4
	#σₑ = 0.00001
...
# ╔═╡ 837c77b0-a7a2-4b42-a09e-85889eaa4549
begin
...
# ╔═╡ 152e4afa-b04f-4ea8-95fd-b364da6ea303
function a()
	for i in 1:100
		return i
	end
...
# ╔═╡ 8fceafb9-d84c-4fee-96ab-78ae2b13d7e4
@time a

# ╔═╡ f5972b41-6b90-46bd-96d5-61fa414d6a8b
begin
	begin
		numt1 = 60
		equiSi, featureSi, energySi, forceSi, TargetSi = ASEFeatureTarget(
		 ...
		 FC_Si, K₀₀Si, K₁₁Si, KₘₘSi, KₙₘSi = PosteriorMean(featureSi, equiSi, TargetSi, kₛₑ2, l, σₑ, σₙ, order3, model)
		FC_Si
	end
end

# ╔═╡ 751cc075-0949-4deb-994b-4dda731f9628
#for i in 1:10
#	numt1 = nd[i]
#	equiSi, featureSi, energySi, forceSi, TargetSi = ASEFeatureTarget(
#			"feature_Si_222spc_01_n100_PW800_kpts9_e100_d1.csv",
#			"energy_Si_222spc_01_n100_PW800_kpts9_e100_d1.csv", 
#			"force_Si_222spc_01_n100_PW800_kpts9_e100_d1.csv", numt1, DIM)
#	@time FC_Si, K₀₀Si, K₁₁Si, KₘₘSi, KₙₘSi = PosteriorMean(featureSi, equiSi, #TargetSi, kₛₑ2, l, σₑ, σₙ, order3, model)
#	P3[:,:,:,i] = FC_Si
...
julia_version = "1.8.1"
manifest_format = "2.0"
project_hash = "f3aff8aa84a1fa0e038d0e11abf3102b87665f07"
