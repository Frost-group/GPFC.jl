...
begin
	Ecar = zeros((9))
	Eph = zeros((9))
	FC2car = zeros(( 48, 48, 9))
	FC2ph = zeros(( 6, 6, 9))
	nd = [1, 5 , 10, 15, 20, 30, 50, 70, 100]
end;
...
anim = @animate for i in 1:9
	plot(nd[1:i], [Ecar[1:i], Eph_Norm[1:i]],
...
anim2 = @animate for i in 1:9
	plot(nd[1:i], [logEcar[1:i], logEph[1:i]],
		xlabel="Training points",
