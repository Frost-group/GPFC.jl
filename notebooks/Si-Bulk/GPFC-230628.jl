...
# ╔═╡ bfa5a510-15b2-11ee-0e9c-850da890d2ce
begin
...
# ╔═╡ 3a2bac02-4f18-4340-b12d-82e0594d86a9
begin
	path="vaspout.h5"
	file = h5open(path, "r")
	...
	atomicnumber_ions = [14] # Vector, corresponds to type_ions
	#for i in eachindex(type_ions)
	#	atomicnumber_ions[i] = findall(x->x==type_ions[i],periodic_table[:,2])[1]
	#end
...
# ╔═╡ fa83d288-12fe-48e3-bbef-51a57ea92331
begin
...
# ╔═╡ e1ec8dac-020e-4132-b447-fc385449d139
forces 

# ╔═╡ 0c91cb57-058d-4922-9a58-60f222979b94
intermediate_position_ions

# ╔═╡ 97e21ce8-fd1a-4d27-89ba-2e3e498ae2ef
ETOTAL
...
manifest_format = "2.0"
project_hash = "efc1879d6280b8eaa6ac8d1c2ce4491c313a9c62"
