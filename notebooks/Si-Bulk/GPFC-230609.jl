...
# ╔═╡ 8ae520bc-06c1-11ee-1b34-c5c2bc286096
begin
...
# ╔═╡ 07fb56c9-9f4d-4842-b580-047e5f9d737e
...
# ╔═╡ 46c2b710-d878-4be4-a559-5461972081de
...
for jj in 1:100
	for kk in 1:8
		if kk == 1
			feature_ph[1:6,jj] = PhononTr' * feature[1:6,jj]
		else
			feature_ph[1:6,jj] = feature_ph[1:6,jj] + PhononTr' * feature[6*(kk-1)+1:6*kk,jj]
		end 
	end
end	
...
begin
	...
	for jj in 1:100
		for kk in 1:8
			if kk == 1
				force_ph[1:6,jj] = PhononTr' * force_r[1:6,jj]
			else
				force_ph[1:6,jj] = force_ph[1:6,jj] + PhononTr' * force_r[6*(kk-1)+1:6*kk,jj]
			end 
		end
	end
	Target_ph = zeros((700))
