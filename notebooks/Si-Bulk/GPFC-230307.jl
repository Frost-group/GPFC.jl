...
# ╔═╡ aff44510-bd09-11ed-2502-9b5925a6213f
begin
...
# ╔═╡ 848a21cc-893c-4de2-a393-3964ed3f2574
begin
	using Profile
	using ProfileView
end

# ╔═╡ 755c15b4-e1fd-4b0b-b070-707b236f5aeb
begin
	σₒ = 0.1                    # Kernel Scale
	l = 0.4                     # Length Scale
...
# ╔═╡ c1ba1338-36b0-42a3-82e6-71cf753641d4
begin
...
# ╔═╡ 1cf836e0-1bbe-4086-bb26-fdebb25f365b
...
# ╔═╡ 0871dd33-08af-4e08-a66a-8dd2b8ed0965
...
# ╔═╡ 3addb27e-46d9-4e81-94d9-cd60dc27c5f9
@time K₀₀2, K₁₁2, Kₘₘ2 = Marginal2(feature, kernel, l, σₑ, σₙ, model);

# ╔═╡ 4739a3c1-de6a-4a29-87a8-db76855f2f88
@profile K₀₀2, K₁₁2, Kₘₘ2 = Marginal2(feature, kernel, l, σₑ, σₙ, model);

# ╔═╡ 31cfaf55-0db2-45b4-8372-d229cf1f5852
ProfileView.view()

# ╔═╡ 0c64c3b3-c99b-4432-8d22-8375c526eea5
...
# ╔═╡ 60584992-13f0-4208-8584-b867797781f3
@time K₀ₙₘ = Coveriant2(feature, equi, kernel, 0);

# ╔═╡ 6ea7cbee-74e9-4919-ad82-ba95b5dc2c8d
@time K₁ₙₘ = Coveriant2(feature, equi, kernel, 1);

# ╔═╡ ac627be8-dedf-4b0f-838b-e1769548f2a8
@time K₂ₙₘ = Coveriant2(feature, equi, kernel, 2);

# ╔═╡ 5bbd94af-82b3-4548-8fe4-fd758399432b
@time K₃ₙₘ = Coveriant2(feature, equi, kernel, 3);
...
manifest_format = "2.0"
project_hash = "db6103ad70db3c316360d19c24cd17990704a446"
...
[[deps.ProfileView]]
deps = ["Cairo", "Colors", "Dates", "FileIO", "FlameGraphs", "Graphics", "Gtk", "GtkObservables", "InteractiveUtils", "IntervalSets", "MethodAnalysis", "Preferences", "Profile", "SnoopPrecompile", "UUIDs"]
git-tree-sha1 = "ccddde229613680d3d2cde430f5ecf00413c7b23"
