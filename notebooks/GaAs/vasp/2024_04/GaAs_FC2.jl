...
# ╔═╡ 21ad19a0-e7ea-11ee-2e49-ab5a4c86725c
begin
...
# ╔═╡ ac563b1c-cdd3-4552-b397-054cef058d74
begin
...
# ╔═╡ 703febba-42db-4bfa-97ec-d3177a9b2d61
...
# ╔═╡ 448db27e-5a51-44f0-9bba-ee2d573fb3f1
equi, feature, energy, force, Target = ASEFeatureTarget(
    "feature_vasp", "energy_vasp", "force_vasp", Num, DIM);

# ╔═╡ 9ddc3559-bbd7-4f69-8059-6726f52eae00
energy

# ╔═╡ 3baf5864-1f6d-4e49-b010-8d2fd5a68754
...
# ╔═╡ b6f69d46-0aef-4b47-b5e2-521e2bc64b0e
...
# ╔═╡ 15b80ab0-7bd2-4c53-ad86-0fd97949f83d
...
# ╔═╡ 9ba3e255-b2ac-4f11-a7e2-ab7d8afcdaa2
...
# ╔═╡ 01f1eabc-200b-42c8-a445-7f76b1d2fa5b
@time Kₘₘ = Marginal(kernel, feature, σₑ, σₙ);

# ╔═╡ 9428e5f4-dbec-4ea9-ba09-bb5903851ab1
@time K₂ₙₘ = Coveriance_fc2(kernel, feature, equi);

# ╔═╡ 93a86cf0-e1f2-4702-b205-8d32828d1d2b
@time FC2 = PosteriorFC2(Kₘₘ, K₂ₙₘ, Target);

# ╔═╡ 8b1a7769-f723-4fbe-baa9-f927d7b75072
...
# ╔═╡ 5a7b5923-0167-44b4-935f-a094c186f498
FC2_re = recon_FC2(FC2);

# ╔═╡ c4c3f552-01e9-4b9d-b054-b94770f6bc96
begin
	a1 = mean(
...
# ╔═╡ e37a37b3-d416-40f0-ba47-9d4a10f20487
FC2_re[:,:,2,4]

# ╔═╡ 002fbf97-9d64-4bc8-af26-0009758e16da
begin
	a2 = mean(
...
# ╔═╡ a1309acc-9d66-4dad-b8d9-2a51270c7c20
Predict = [a1, b1, c1, d1, e1, f1, g1 ,h1, i1, a2, b2, c2, d2, e2, f2, g2 ,h2, i2]

# ╔═╡ 8ad4e894-9ade-4a4f-8c8f-954a34caa175
i2

# ╔═╡ f4c9bf8b-7e7f-442a-8bd3-afa9bf6a9709
...
# ╔═╡ 90de2398-13f7-41aa-a251-48ea6bd82d92
rmsd(Phon, Predict; normalize=false)

# ╔═╡ 10479020-cb97-4f62-b9f5-21d3aecf0487
rmsd(Phon, Predict; normalize=false)
