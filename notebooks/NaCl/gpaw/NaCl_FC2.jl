...
# ╔═╡ 99b3df62-cf3d-11ee-3fb1-490cc747d2f3
begin
...
# ╔═╡ ac07a6f1-9984-4b34-b97b-aabd429e3757
begin
...
# ╔═╡ c38096d9-6a10-4217-916b-60eeaee05610
...
# ╔═╡ 30cb2a3d-bd14-4c04-8235-45a52dd952d3
...
# ╔═╡ f5c2e96d-ffe0-490e-a284-223d6b55a89a
...
# ╔═╡ 15b413b4-f6f5-4f08-9ffa-fd612e046fd4
@time Kₘₘ = Marginal(feature, σₑ, σₙ);

# ╔═╡ d08e7b6e-2c73-467f-a8a3-b4cb3e4d9758
@time K₂ₙₘ = Coveriance_fc2(feature, equi);

# ╔═╡ 33402bac-b359-472a-ba5b-076510f3e472
FC2 = Posterior(Kₘₘ, K₂ₙₘ, Target);

# ╔═╡ 07bd41c6-2c4a-4dbf-8549-c828e7ad29d8
begin
	FC2[ 0.0 .< FC2 .< 1.2e-2 ] .= 0.0
	FC2[ 0.0 .> FC2 .> -1.2e-2 ] .= 0.0
end

# ╔═╡ 0e9ae844-8c9d-4e38-96c1-a2bfeb432e05
heatmap(1:size(FC2[:,:],1),
		...
		aspectratio=:equal,
		size=(700, 700),
	    title="NaCl_FC2 (Traning Data = " *string(199) *")" )

# ╔═╡ 0a90e9d1-4314-440e-8bd4-e8affb2fb40b
...
# ╔═╡ 351fc6ff-9290-4b2c-954b-15598c0ff049
FC2_re = recon_FC2(FC2);

# ╔═╡ c134b7f0-0e77-4fd3-8b80-2ffcbdb8da35
begin
	a1 = mean(
...
# ╔═╡ 76c047b3-dde7-476f-86de-e0ddab5dbba0
FC2_re[:,:,1,15]

# ╔═╡ 499835e8-507a-49d4-8365-0cd81b5519dd
d1

# ╔═╡ a871429b-d150-40fe-a145-97d528e64c65
g1

# ╔═╡ 43e57260-65e7-4338-976c-96df4cba951e
begin
	a2 = mean(
...
# ╔═╡ 8f532ee6-88f9-4d30-8221-a9bf554b8375
g2

# ╔═╡ dc213364-440d-4b26-80f5-802667983d16
FC2_re[:,:,4,14]
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "e111a092529a5c52ed76e8f7ec669721ec7ab13d"
