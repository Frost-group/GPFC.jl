...
# ╔═╡ 02ae5c76-8935-11ee-33af-9b924d81b8ff
begin
...
# ╔═╡ 4276263f-981d-4ffe-a03e-b5bb5a5dd21f
begin
...
# ╔═╡ b654fb9e-5650-42ac-befc-9c939bb11a89
...
# ╔═╡ 3822fdaa-f13f-421c-919c-f615bc3f1fc0
...
# ╔═╡ 5e17aa70-c9a4-4cd6-b008-eb65b82b2588
...
# ╔═╡ a4f08e60-58be-4770-8d16-3bc6da4d05af
...
# ╔═╡ 01fe7d68-9e71-419b-96be-14c58ace33a1
begin
	nd = [1,5,10,15,20,30,40,50,60,80,100,120,140,160,199]
	P3 = zeros(( 48, 48, 48, size(nd,1)))
	SumRule3 = zeros((size(nd,1)))
end;

# ╔═╡ 4c08923d-0374-449c-b52b-7df870cb7b67
...
# ╔═╡ 3b72136e-9554-49bb-b409-a56c207df90e
animCar = @animate for i in 1:size(nd,1)
	heatmap(1:size(P3[2,:,:,i],1),
		    ...
		    title="NaCl_FC3 (Traning Data = " *string(nd[i]) *")")
end

# ╔═╡ a3242fc0-db2c-4bff-803c-337be5a17fec
gif(animCar, "NaCl_FC3_1_Cart.gif", fps=2)

# ╔═╡ 5a6af6c3-b7d3-442c-bc67-aef737e1e973
anim = @animate for i in 1:size(nd,1)
	plot(nd[1:i], SumRule3[1:i],
		...
		labels = "Cartesian",
		linewidth=3,
		title="NaCl_Sum-Rule_FC3 (Traning Data = " *string(nd[i]) *")"
	)
end

# ╔═╡ f120a98b-97b9-4951-b5df-ffa2af3f4473
gif(anim, "NaCl_FC3_Cart.gif", fps=2)

# ╔═╡ a6f80d26-2904-4974-83f0-e95c95db865e
SumRule3
