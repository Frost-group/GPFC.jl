...
# ╔═╡ 12a92870-823e-11ee-2dc8-adbab9593255
begin
...
# ╔═╡ 9507f7ce-32fc-4849-9b05-9670bdf91281
...
# ╔═╡ ffac902b-4d64-472d-af98-347a2f0990da
...
# ╔═╡ 3cffa732-a843-4c0b-a982-1f4af1141dfc
...
# ╔═╡ e7a85e03-dae7-4d8a-ab53-07d0a0439c62
...
# ╔═╡ 411fd658-b994-4e7e-8dea-b6e43c445a70
begin
...
# ╔═╡ 90c94e47-e463-42c0-83b2-a400f11d33e7
FC2= Posterior(Kₘₘ, K₂ₙₘ, Target);

# ╔═╡ ed21ff36-66b1-4041-9f20-83ed92f13231
sum(FC2)

# ╔═╡ 19eb25fd-eccc-4cd2-bb12-9ece47d07736
heatmap(1:size(FC2[:,:],1),
		...
		aspectratio=:equal,
		size=(700, 700),
	    title="FC2 (Traning Data = " *string(199) *")" )

# ╔═╡ 0ca6c1a5-49e4-48bd-9ddd-8135a4f28faf
sum(FC2)

# ╔═╡ ecf22ce0-923c-4391-bb4e-d0a57c530517
