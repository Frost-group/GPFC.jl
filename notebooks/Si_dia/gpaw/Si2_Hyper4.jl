...
# ╔═╡ 9d23fc20-d5a7-11ee-35b8-f3bd10745fb6
begin
...
# ╔═╡ e1814478-0cab-4133-b7a5-026fc22e64b5
begin
...
# ╔═╡ 5216f85f-509c-4e16-84e6-74131f5d4d59
...
# ╔═╡ fdfccb2d-adb2-42b3-a546-5043b8e931fa
...
# ╔═╡ ef4e9f04-cd5a-418e-94a0-06409becbd73
...
# ╔═╡ bb59a0da-cb46-41c6-95be-0f3f305facee
...
# ╔═╡ d1e21dbb-777c-4837-8887-3cad8cf03e64
begin
	Σₒ = [7.5e-3, 1e-2, 2.5e-2, 5e-2, 7.5e-2, 1e-1, 2.5e-1, 5e-1, 7.5e-1, 1.]
	L = [1e-1, 2e-1, 3e-1, 4e-1, 5e-1, 6e-1, 7e-1, 8e-1, 9e-1, 1.]
	numHyper = size(Σₒ,1)
...
# ╔═╡ 6287af81-fc4e-425d-a24d-19741ec6153e
...
# ╔═╡ 17a232a2-ac4a-4bd3-9f13-c44cb6289699
begin
	heatmap(1:numHyper, 1:numHyper, broadcast(abs, Asum),
		    c=cgrad(["#064635","#519259", "#96BB7C", "#F0BB62", "#FAD586","#F4EEA9"]),
		    xlabel="Kernel Scale",
			ylabel="Lenght Scale",
			aspectratio=:equal,
			size=(700, 700),
		    title="d-Si Acoustic Sum-rule" )
	#savefig("Si2_Acoustic_Scale.png")
end

# ╔═╡ d119c7cc-1119-47c5-806d-61e97e312531
begin
	heatmap(1:numHyper, 1:numHyper, broadcast(abs, Osum),
		    c=cgrad(["#064635","#519259", "#96BB7C", "#F0BB62", "#FAD586","#F4EEA9"]),
		   	xlabel="Kernel Scale",
			ylabel="Lenght Scale",
			aspectratio=:equal,
			size=(700, 700),
		    title="d-Si Net forces" )
	#savefig("Si2_NetForce_Scale.png")
end

# ╔═╡ a41478d8-5d46-47e1-b7be-489a259d4744
begin
	heatmap(1:numHyper, 1:numHyper, RMSE,
		    c=cgrad(["#064635","#519259", "#96BB7C", "#F0BB62", "#FAD586","#F4EEA9"]),
		    xlabel="Kernel Scale",
			ylabel="Lenght Scale",
			aspectratio=:equal,
			size=(700, 700),
		    title="d-Si RMSE" )
	#savefig("Si2_RMSE_Scale.png")
end

# ╔═╡ bb3049f8-4fce-46b2-8613-3e6ca247d07f
findmin(broadcast(abs, Osum))

# ╔═╡ 162ffc8f-9818-4360-bc32-30d6ff6710dc
findmin(broadcast(abs, Asum))

# ╔═╡ a69477dd-cf3e-4866-abf3-ab563d6c00b7
Σₒ[5]

# ╔═╡ bf7364b2-4340-4df3-8d94-a9186dcecbee
L[1]

# ╔═╡ 90a99d9c-da32-4a24-b375-6e2debf57f20
Σₒ[3]

# ╔═╡ 87c5e5c4-d33b-4bdd-8e40-d77eec41825f
L[2]

# ╔═╡ 65ae96ab-3a43-4d05-a9c0-57a4530a2048
findmin(RMSE)

# ╔═╡ 767ebe80-ba16-47e6-8591-a1d024e9b8f3
RMSE
