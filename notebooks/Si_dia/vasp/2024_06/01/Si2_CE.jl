...
equi₂, featu₂, Targ₂ = Cluster(equi, feature, force, energy, 2, 1)
...
gif(animCar, "Si2_FC3_Cart.gif", fps=2)
...
@time for j in 1:size(nd,1)
	...
	equi₂, featu₂, Targ₂ = Cluster(equi, feature, force, energy, 1, 2)
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "3ee4a7d2ce0a4510d8e51ee95d6ff8fc8a69ca32"
