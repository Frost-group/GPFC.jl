...
equi2, F2C2, feature2, energy2, forces2, Target2 = VASP_input("2023Oct/05/ISIF2/vaspout.h5")

# ╔═╡ ab87f51c-96b7-4927-8a89-1d608cffcd86
begin
	equi = F2C1*[0.125, 0.125, 0.125,
		0.625, 0.125, 0.125,
		0.125, 0.625, 0.125, 
		0.625, 0.625, 0.125,
		0.125, 0.125, 0.625, 
...
begin
	Target = hcat(hcat(GSEner, Target1), Target2);
	feature = hcat(hcat(equi, feature1), feature2)
end;

# ╔═╡ 5c6796f1-99e3-4d5b-9166-f5d616b272c8
begin
	σₒ = 0.1             		# Kernel Scale
	l = 0.07028262296826316 	# Length Scale
...
begin
	sd = zeros(48)
	for ii in 1:48
		sd[ii] = std(feature[ii:ii,1:81])
	end
	sd
end

# ╔═╡ 475f65cf-db82-447b-9d9d-0cbf59b2911f
feature[39:39,42:50]

# ╔═╡ fde768b5-3da7-40bc-975e-29f4e27d2daf
Target[1:1,1:42]

# ╔═╡ 741f8d80-fb92-4732-8270-1ea13f53a5dc
feature[1:1,1:42]

# ╔═╡ a44b7c6a-df1e-4bf3-8a9e-cb4df8c97356
begin
	num = 81
		plot(feature[1,1:num], Target[1,1:num], seriestype=:scatter,  legend =false)
		plot!(feature[2,1:num], Target[1,1:num], seriestype=:scatter,  legend =false)
		plot!(feature[3,1:num], Target[1,1:num], seriestype=:scatter,  legend =false)
end
...
begin
	...
	plot(feature[5,1:num], Target[1,1:num], seriestype=:scatter,  legend =false)
	plot!(feature[6,1:num], Target[1,1:num], seriestype=:scatter,  legend =false)	
end
  ╠═╡ =#
...
manifest_format = "2.0"
project_hash = "f6033b0d4f59771a1339cc488cfe775df23d3234"
