...
# ╔═╡ e47f62c2-cff0-11ee-045f-c9384559b628
begin
...
# ╔═╡ e3dac407-b72e-4c1b-a419-0d859568b50c
begin
	σₒ = 1                  	# Kernel Scale
	l = 1
	# Length Scale
...
# ╔═╡ 66497f5a-5332-494f-923a-5f87cdfb511d
L = zeros(3, size(Mass,1)*Supercell[1]*Supercell[2]*Supercell[3])

# ╔═╡ 6e73a042-d713-43be-a307-6a188b71d5ce
function l_vector(l, Mass, Supercell)
	NumAtom = size(Mass,1)
	SupSize = Supercell[1] * Supercell[2] * Supercell[3]
	L = zeros(3, NumAtom * SupSize)
	for i in 1:NumAtom
		for j in 1:SupSize
			L[:,2*(j-1)+i] = 1/sqrt(Mass[i])*l*ones(3,1)
		end
	end
	LL = reshape(L, (3 * NumAtom * SupSize))
	return LL
end	

# ╔═╡ 72368895-4ae1-49ec-a58d-59de77890b9a
ARDkernel = σₒ^2 * SqExponentialKernel() ∘ ARDTransform(l_vector(l, Mass, Supercell))

# ╔═╡ 7a360ad2-c873-42ff-a87d-c1ed6e2a8a43
l_vector(l, Mass, Supercell)

# ╔═╡ f09bdc69-af22-4257-b698-22d774b497da
begin
	function kernelfunction1(x₁, x₂)
		return Zygote.gradient( a -> ARDkernel(a, x₂), x₁)[1]
	end
...
# ╔═╡ 14b7ef2a-b967-47c3-b5a8-a90964cc10f4
...
# ╔═╡ d22f6f4c-dab5-449b-a604-4e48a599b66c
...
# ╔═╡ d5033f61-6fce-4bd1-8ebb-e4fde3aadc17
...
# ╔═╡ 61ef691a-2bf5-4523-83fc-68ef1708f098
@time Kₘₘ = Marginal(feature, σₑ, σₙ);

# ╔═╡ e76deb6f-06f3-4e1a-ac20-945575ef2076
@time K₂ₙₘ = Coveriance_fc2(feature, equi);

# ╔═╡ a9ed8e11-b964-4868-bc43-bd549835d540
@time FC2 = Posterior(Kₘₘ, K₂ₙₘ, Target);

# ╔═╡ 17220ed4-f5a5-4203-8e0a-56a8dddaab66
...
# ╔═╡ 23c90f46-1433-43bf-8941-ce87734618aa
...
# ╔═╡ b0047188-e9fe-4519-ade5-2669f260d3c3
FC2_re = recon_FC2(FC2);

# ╔═╡ 1386c48a-60e9-48d9-8999-a51f7168ba62
begin
	a1 = mean(
...
# ╔═╡ bcec02e2-d422-4aca-b7be-e9e4f9ee2975
begin
	a2 = mean(
...
# ╔═╡ 5fa7d488-a429-45df-87a3-42aff3f3ed22
Predict = [a1, b1, c1, d1, e1, f1, g1 ,h1, a2, b2, c2, d2, e2, f2, g2 ,h2]

# ╔═╡ 521b375a-7fe4-42ca-9db9-c32f16a659e4
...
# ╔═╡ dbb5308c-e6d7-4cbf-93c5-42c50dcd08f4
